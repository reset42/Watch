# screens/wifi_status.py — placeholder to keep navigation working
SCREEN_ID = "wifi_status"
    ...
    def render_full(self):
        ...
        try:
            ...
            if hasattr(d, "draw_text"):
                d.draw_text(8, 8, "wifi_status")
            elif hasattr(d, "text"):
                try: d.text(8, 8, "wifi_status")
                except TypeError: d.text(8, 8, "wifi_status", WHITE)
        except Exception: pass
        try:
