# screens/msg_inbox.py — placeholder to keep navigation working
SCREEN_ID = "msg_inbox"
    ...
    def render_full(self):
        ...
        try:
            ...
            if hasattr(d, "draw_text"):
                d.draw_text(8, 8, "msg_inbox")
            elif hasattr(d, "text"):
                try: d.text(8, 8, "msg_inbox")
                except TypeError: d.text(8, 8, "msg_inbox", WHITE)
        except Exception: pass
        try:
