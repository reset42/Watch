# screens/bt_status.py — placeholder to keep navigation working
SCREEN_ID = "bt_status"
    ...
    def render_full(self):
        ...
        try:
            ...
            if hasattr(d, "draw_text"):
                d.draw_text(8, 8, "bt_status")
            elif hasattr(d, "text"):
                try: d.text(8, 8, "bt_status")
                except TypeError: d.text(8, 8, "bt_status", WHITE)
        except Exception: pass
        try:
