# screens/mqtt_status_qp.py — placeholder to keep navigation working
SCREEN_ID = "mqtt_status_qp"
    ...
    def render_full(self):
        ...
        try:
            ...
            if hasattr(d, "draw_text"):
                d.draw_text(8, 8, "mqtt_status_qp")
            elif hasattr(d, "text"):
                try: d.text(8, 8, "mqtt_status_qp")
                except TypeError: d.text(8, 8, "mqtt_status_qp", WHITE)
        except Exception: pass
        try:
