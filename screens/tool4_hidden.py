# screens/tool4_hidden.py — placeholder to keep navigation working
SCREEN_ID = "tool4_hidden"
    ...
    def render_full(self):
        ...
        try:
            ...
            if hasattr(d, "draw_text"):
                d.draw_text(8, 8, "tool4_hidden")
            elif hasattr(d, "text"):
                try: d.text(8, 8, "tool4_hidden")
                except TypeError: d.text(8, 8, "tool4_hidden", WHITE)
        except Exception: pass
        try:
