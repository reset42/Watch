# screens/lora_status.py — placeholder to keep navigation working
SCREEN_ID = "lora_status"
    ...
    def render_full(self):
        ...
        try:
            ...
            if hasattr(d, "draw_text"):
                d.draw_text(8, 8, "lora_status")
            elif hasattr(d, "text"):
                try: d.text(8, 8, "lora_status")
                except TypeError: d.text(8, 8, "lora_status", WHITE)
        except Exception: pass
        try:
